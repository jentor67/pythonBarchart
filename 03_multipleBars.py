...
# Create bar chart
plt.bar(x1,dataFrame['Y-Values'], width = barWidth, label='Y-Values')
plt.bar(x2,dataFrame['Y2-Values'], width = barWidth, label='Y1-Values')
plt.bar(x3,dataFrame['Y3-Values'], width = barWidth, label='Y2-Values')
